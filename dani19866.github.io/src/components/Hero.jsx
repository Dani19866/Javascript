    ...
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row gap-4 h-full lg:h-[725px]">
                ...
                {/* Text Hero */}
                <div className="w-full md:w-[55%] flex items-center justify-center relative overflow-hidden boxShadow py-7 px-5">
                    ...
                    {/* Text */}
                    <div className='w-[658px] xl:w-[800px] flex flex-col z-10 relative gap-y-7 md:p-10 lg:mt-28'>

                        {/* Title */}
                        <h1 className="text-5xl md:text-6xl lg:text-7xl  font-extrabold">Lleva tu empresa al otro nivel con personal capacitado</h1>
